...
<main>
    ...
    <section class="breadcrumb-area">
        <div class="breadcrumb-widget  breadcrumb-widget-3 pt-200 pb-200"
            style="background-image: url('{{ asset('assetsfront/img/breadcrumb/bg-4.jpg') }}')">
                    ...
                    <div class="row mt-55">
                        <div class="col-sm-6">
                            <div class="get-touch-box">
                                <div class="icon">
                                    ...
                                    <img src="{{ asset('assetsfront/img/contact/call-outline.png')}}" alt="call icon">
                                </div>
                                <div>
                        ...
                        <div class="col-sm-6">
                            <div class="get-touch-box">
                                <div class="icon">
                                    ...
                                    <img src="{{ asset('assetsfront/img/contact/mail-open-outline.png')}}" alt="mail icon">
                                </div>
                                <div>
                                    <p>Email us:</p>
                        ...
                        <div class="col-sm-6">
                            <div class="get-touch-box mt-30">
                                ...
                                <div>
                                    <p>Location</p>
                                    <span>Bijoynagar,Dhaka,Bangladesh</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
            ...
            <div class="row mt-60 gy-lg-0 gy-4">
                <div class="col-lg-4">
                    <div class="feature-card-widget-4 wow fadeInUp" data-wow-delay="0.1s">
                        <img src="{{ asset('assetsfront/img/contact/help-icon-1.svg')}}" alt="icon">
                ...
                <div class="col-lg-4">
                    <div class="feature-card-widget-4 wow fadeInUp" data-wow-delay="0.3s">
                        <img src="{{ asset('assetsfront/img/contact/help-icon-2.svg')}}" alt="icon">
                ...
                <div class="col-lg-4">
                    <div class="feature-card-widget-4 wow fadeInUp" data-wow-delay="0.5s">
                        <img src="{{ asset('assetsfront/img/contact/help-icon-3.svg')}}" alt="icon">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 position-relative">
                    <div class="cta cta-bg-violet" style="background-image: url('{{ asset('assetsfront/img/cta/wave.png')}}')">
