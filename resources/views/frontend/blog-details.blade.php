...
@section('title', 'Blog details - My Laravel Website')
...
<main>
    ...
    <section class="breadcrumb-area" id="banner_animation2">
        <div class="breadcrumb-widget breadcrumb-widget-2  pt-200 pb-145"
            style="background-image: url('{{asset('assetsfront/img/breadcrumb/bg-3.jpg')}}');">

            <div class="shapes">
                <div class="one-shape shape-3" data-parallax='{"x": -100, "y": 0, "rotateZ":0}'>
                    <img src="{{asset('assetsfront/img/breadcrumb/Polygon-3.png')}}" alt="shape">
                </div>
                <div class="one-shape shape-4" data-parallax='{"x": -200, "y": 0, "rotateZ":0}'>
                    <img src="{{asset('assetsfront/img/breadcrumb/Polygon-4.png')}}" alt="shape">
                </div>
            </div>
            <div class="container">
                <div class="row">
                        ...
                        <div class="breadcrumb-content pt-50">
                            ...
                            <div class="post-info mt-5">
                                <div class="autor mr-20">
                                    <img src="{{asset('assetsfront/img/blog/user-profile.png')}}" alt="icon">
                                    <span>Zain Siphron</span>
                                </div>
                                <div class="date">
                                    <img src="{{asset('assetsfront/img/blog/calendar-outline.png')}}" alt="icon">
            ...
            <div class="row gy-lg-0 gy-4">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="post-details-widget pb-70 border-bottom position-relative">
                        <img class="post-img w-100" src="{{asset('assetsfront/img/blog/blog-details-img.jpg')}}" alt="post image">
                        ...
                        <blockquote class="wow fadeInUp">
                            ...
                            <p>He legged it that blatant brown bread some dodgy chav super a blinding shot my lady
                                ...
                                pukka</p>
                            <div class="author">
                                <img class="img-fluid rounded-circle" src="{{asset('assetsfront/img/blog/quote-author.png')}}" alt="">
                                <div>
                                    <h6>Jesus Requena </h6>
                        ...
                        <img class="post-img w-100" src="{{asset('assetsfront/img/blog/blog-details-img-2.jpg')}}" alt="post img">
                    ...
                    <div class="author-media-widget mt-90 mb-90">
                        <div class="author-img">
                            <img class="rounded-circle" src="{{asset('assetsfront/img/blog/author-1.png')}}" alt="author">
                        </div>
                        ...
                        <div class="row gy-md-0 gy-4">
                            <div class="col-md-6">
                                <div class="blog-widget-2 wow fadeInUp" data-wow-delay="0.1s">
                                    <div class="blog-img">
                                        <img src="{{asset('assetsfront/img/blog/blog-9.png')}}" alt="blog-img">
                                    ...
                                    <div class="blog-content">
                                        ...
                                        <div class="post-info">
                                            <div class="author">
                                                <img src="{{asset('assetsfront/img/blog/user-profile.svg')}}" alt="user profile">
                                                <span>Zain Siphron</span>
                                            </div>
                                            <div class="post-date">
                                                <img src="{{asset('assetsfront/img/blog/calendar-outline.svg')}}" alt="calendar">
                                                <span>March 18, 2021</span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="blog-widget-2 wow fadeInUp" data-wow-delay="0.3s">
                                    <div class="blog-img">
                                        <img src="{{asset('assetsfront/img/blog/blog-7.png')}}" alt="blog-img">
                                        <div class="catagory bg_primary">buisiness</div>
                                    </div>
                                    <div class="blog-content">
                        ...
                        <div class="comment-author">
                            <ul>
                                <li>
                                    <div class="comments-box">
                                        <div class="comments-avatar">
                                            <img class="rounded-circle" src="{{asset('assetsfront/img/blog/comment-1.png')}}" alt="img">
                                        </div>
                                        <div class="comments-text">
                                            <div class="avatar-name">
                                                <h5>Karon Balina</h5>
                                                <div class="post-date">
                                                    <img src="{{asset('assetsfront/img/blog/calendar-outline.svg')}}" alt="">
                                                    <span>March 18, 2021</span>
                                                </div>
                                ...
                                <li class="children">
                                    <div class="comments-box">
                                        <div class="comments-avatar">
                                            <img class="rounded-circle" src="{{asset('assetsfront/img/blog/comment-2.png')}}" alt="img">
                                        </div>
                                        <div class="comments-text">
                                            <div class="avatar-name">
                                                <h5>Julias Roy</h5>
                                ...
                                <li>
                                    <div class="comments-box">
                                        <div class="comments-avatar">
                                            <img class="rounded-circle" src="{{asset('assetsfront/img/blog/comment-3.png')}}" alt="img">
                                        </div>
                                        <div class="comments-text">
                                            <div class="avatar-name">
                    ...
                    <div class="blog-sidebar-widget ps-lg-2">
                        ...
                        <div class="widget-social mt-40">
                            <div class="row text-center gx-3 gy-3 gy-md-0">
                                <div class="col-md-4">
                                    <a href="#">
                                        <img src="{{asset('assetsfront/img/social/facebook-logo.svg')}}" alt="faceebook">
                                        <h6>815.5K</h6>
                                        <span>Fans</span>
                                    </a>
                                </div>
                                <div class="col-md-4">
                                    <a href="#">
                                        <img src="{{asset('assetsfront/img/social/twitter.svg')}}" alt="twitter">
                                        <h6>107.2K</h6>
                                        <span>Followers</span>
                                    </a>
                                </div>
                                <div class="col-md-4">
                                    <a href="#">
                                        <img src="{{asset('assetsfront/img/social/youtube.svg')}}" alt="youtube">
                                        <h6>90.6K</h6>
                        ...
                        <div class="widget-news mt-50">
                            ...
                            <ul class="recent-post">
                                <li>
                                    <img src="{{asset('assetsfront/img/blog/recent-post-1.png')}}" alt="recent-post">
                                    <div class="news-content">
                                        <h6><a href="#">Is It Worth Buying A Premium Form Builder.</a></h6>
                                        <div class="post-date">
                                            <img src="{{asset('assetsfront/img/blog/calendar-outline.svg')}}" alt="calender">
                                            <span>March 18, 2021</span>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <img src="{{asset('assetsfront/img/blog/recent-post-2.png')}}" alt="recent-post">
                                    <div class="news-content">
                                ...
                                <li>
                                    <img src="{{asset('assetsfront/img/blog/recent-post-3.png')}}" alt="recent-post">
                                    <div class="news-content">
                                ...
                                <li>
                                    <img src="{{asset('assetsfront/img/blog/recent-post-4.png')}}" alt="recent-post">
                                    <div class="news-content">
