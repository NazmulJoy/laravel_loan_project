...
style="background-image: url({{ asset('assetsfront/img/footer/footer-bg-2.png') }});">
            ...
            <div class="col-lg-3  col-sm-6 text-center text-sm-start">
                <div class="footer-widget mb-30 wow fadeInLeft">
                    ...
                    <div class="truspilot mt-40">
                        <img src="{{ asset('assetsfront/img/footer/Trustpilot.png') }}" alt="Trustpilot">
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-8 offset-xl-4">
                <div class="row align-items-center gy-lg-0 gy-3 gx-0">
                    <div class="col-md-2  text-md-start text-center">
                        <a href="index.html"><img src="{{ asset('assetsfront/img/logo/Logo.png') }}" alt="logo"></a>
                    </div>
                    <div class="col-md-6">
                        <div class="line"></div>
                    </div>
